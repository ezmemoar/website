  ...
  <div class="bg-primary bg-opacity-80 min-h-screen overflow-x-hidden">
    <div class="py-20">
      <div class="absolute z-[-1] w-full overflow-x-hidden" >
        ...
        <div class="bg-[url('../../gallery/mommy-vegetable-center.png')] w-full bg-cover h-[30rem] bg-no-repeat bg-center-top">
        </div>
      </div>
      <div class="px-36 z-50">
        <h1 class="text-2xl font-bold text-gray-50 my-14 font-[Poppins]">Corporate social responsibility</h1>
